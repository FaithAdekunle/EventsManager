                              ...
                              (index === 0 || index % 2 === 0 ? (
                                <tr key={event.id}>
                                  <td
                                    ...
                                    'declined' : ''}
                                    onMouseEnter={
                                      AdminCenter.onMouseEnterDate}
                                    onMouseLeave={
                                      AdminCenter.onMouseLeaveDate}
                                  >
                                  ...
                                  </td>
                                  {
                                    center.events[index + 1] ? (
                                      <td
                                        className={!center.events[index + 1]
                                          .isAccepted ? 'declined' : ''}
                                        onMouseEnter={AdminCenter
                                          .onMouseEnterDate}
                                        onMouseLeave={AdminCenter
                                          .onMouseLeaveDate}
                                      >
                                        {center
                                          .events[index + 1]
                                          .start === center.events[index + 1]
                                          .end ?
                                          center.events[index + 1].start :
                                          `${center.events[index + 1].start} - 
                                          ${center.events[index + 1].end}`}
                                        {center.events[index + 1].isAccepted ? (
                                          <i
                                            className="fa fa-times pull-right"
                                            aria-hidden="true"
                                    ...
                                    <div className="row">
                                      {
                                        ...
                                        const checked = center.facilities
                                          .includes(facility);
